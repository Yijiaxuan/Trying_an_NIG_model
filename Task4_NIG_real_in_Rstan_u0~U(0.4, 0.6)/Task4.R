...
comb.s <- makeCombined()
write.csv(comb.s, "C:/Users/16438/Desktop/Reaserch Project/Trying NIG model/Task4_NIG_real_data_in_Rstan/comb.s.csv", row.names = FALSE)
real_data <- read.csv("C:/Users/16438/Desktop/Reaserch Project/Trying NIG model/Task4_NIG_real_data_in_Rstan/comb.s.csv")
...
# run stan
library(rstan)
fit <- run_NIG_real (real_data, "ALP", 2019, "/Users/16438/Desktop/Reaserch Project/Trying NIG model/Task4_NIG_real_data_in_Rstan/Task4.stan")
print(fit)

fit2 <- run_NIG_real (real_data, "LNP", 2016, "/Users/16438/Desktop/Reaserch Project/Trying NIG model/Task4_NIG_real_data_in_Rstan/Task4.stan")
print(fit2)
